...
@Deprecated
public class MovieComingNewJson extends BaseData{
    ...
    public static class AttentionBean extends BaseData{
    ...
    public static class MoviecomingsBean extends BaseData implements ISuspensionInterface{
        private String actor1;
        private String actor2;
        private String director;
        private int id;

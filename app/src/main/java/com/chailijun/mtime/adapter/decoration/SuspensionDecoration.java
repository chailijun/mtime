...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_LINE = Color.parseColor("#FFD8D8D8");
...
/*
        ...
        c.drawLine(child.getPaddingLeft(),child.getTop(),child.getWidth(),child.getTop(),mPaint);
    }
...
//                Log.d("zxt", "onDrawOver() called with: c = [" + child.getTop());//当getTop开始变负，它的绝对值，是第一个可见的Item移出屏幕的距离，
        ...
        c.drawText(tag, child.getPaddingLeft(),
                ...
                mPaint);
        mPaint.setColor(COLOR_LINE);
        c.drawLine(child.getPaddingLeft(), parent.getPaddingTop() + mTitleHeight,

...
/**
 * author： Chailijun
 * date  ： 2017/1/10 11:39
 * e-mail： 1499505466@qq.com
 */

public class MostAttentionAdapter extends BaseQuickAdapter<MovieComingNew.AttentionBean,BaseViewHolder>{

    public MostAttentionAdapter(List<MovieComingNew.AttentionBean> data) {
        super(R.layout.fragment_payticket_movie_coming_movie_most_attention_item, data);
    }

    @Override
    protected void convert(BaseViewHolder holder, final MovieComingNew.AttentionBean data) {
